...
export default function AdminNotificationSettings() {
  // Notification/SMTP settings are store-governance, ADMIN-only (the store owner) - SUPER_ADMIN
  // (the software owner) has no store-level access at all, see RoleName's own doc comment.
    ...
    return (
      <div className="flex min-h-dvh items-center justify-center bg-zinc-950 px-4">
        <div className="w-full max-w-md rounded-xl border border-zinc-800 bg-zinc-900 p-8 text-center shadow-xl">
          ...
          <p className="mt-2 text-sm text-zinc-400">You need the ADMIN role to manage notification settings.</p>
          <Link
            to="/admin"
